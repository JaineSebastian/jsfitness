...
public class custom_view_equipment extends BaseAdapter implements View.OnClickListener {
    String[] id,uid,equipment;
    private Context context;
    ImageView img;
    String[] urll;
    Button trainer;

    public custom_view_equipment(Context applicationContext, String[] uid, String[] equipment, String[] urll, String[] id) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(view==null)
        {
            ...
            gridView=inflator.inflate(R.layout.activity_custom_view_equipment,null);//same class name
